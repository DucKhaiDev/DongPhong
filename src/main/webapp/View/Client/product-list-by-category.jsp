...
<html lang="en">
<head>
    <title>Sản Phẩm ${category.categoryName} - Đồ gỗ Cao cấp Đông Phong</title>
    <meta charset="UTF-8">
        ...
        <div class="flex-w flex-sb-m p-b-36">
            <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                <div class="bread-crumb flex-w p-r-15 p-t-30 p-lr-0-lg">
                    ...
                    <a href="${pageContext.request.contextPath}/products/room?id=${category.room.roomId}"
                       class="stext-109 cl8 hov-cl1 trans-04 font-size-15">
                                        ...
                                        <li><label class="checkbox">
                                            ...
                                            <small>
                                                <a>
                                                    ...
                                                    out.print(Constant.Service.PRODUCT_SERVICE.countProduct(categoryId, brandId));
                                                %>)
                                                </a>
                                            </small>
                                        </label></li>
