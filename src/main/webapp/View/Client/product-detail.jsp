            ...
            <div class="col-md-6 col-lg-5 p-b-30">
                <div class="p-r-50 p-t-5 p-lr-0-lg">
                    ...
                    <c:if test="${product.productCost != '0' && product.productCost != product.productPrice}">
                        <span class="mtext-106 cl2 product-cost">
                            <% out.print(dongFormat.format(productCost)); %>
                        </span>
                    </c:if>

                    <%
                        boolean b = productPrice.compareTo(productCost) < 0;
                        request.setAttribute("b", b);

                        BigDecimal percentage;
                    %>
                    <c:if test="${b}">
                        <span class="mtext-106 cl2 product-sale-off">
                            <%
                                percentage = ((productCost.subtract(productPrice)).divide(productCost, 2, RoundingMode.HALF_UP)).multiply(new BigDecimal("100")).setScale(0, RoundingMode.UP);
