...
<header class="header-v4">
    ...
    <div class="container-menu-desktop">
        ...
        <div class="wrap-menu-desktop how-shadow1">
            <nav class="limiter-menu-desktop container">
                ...
                <!-- Logo desktop -->
                <a href="#" class="logo">
                    <img src="${pageContext.request.contextPath}/assets/images/icons/logo-01.png" alt="IMG-LOGO">
                </a>
    ...
    <div class="wrap-header-mobile">
        ...
        <div class="logo-mobile">
            <a href="index.jsp"><img src="${pageContext.request.contextPath}/assets/images/icons/logo-01.png" alt="IMG-LOGO"></a>
        </div>
                    ...
                    <div class="wrap-table-shopping-cart">
                        <table class="table-shopping-cart">
                            ...
                            <tr class="table_row">
                                <td class="column-1">
                                    <div class="how-itemcart1">
                                        <img src="${pageContext.request.contextPath}/assets/images/item-cart-04.jpg" alt="IMG">
                                    </div>
                                </td>
                            ...
                            <tr class="table_row">
                                <td class="column-1">
                                    <div class="how-itemcart1">
                                        <img src="${pageContext.request.contextPath}/assets/images/item-cart-05.jpg" alt="IMG">
                                    </div>
                                </td>
