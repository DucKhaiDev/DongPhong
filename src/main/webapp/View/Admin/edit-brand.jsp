                            ...
                            <div class="row">
                                <form action="<c:url value="/admin/brand/edit"/>" method="post">
                                    <div class="row ml-1 mr-1">
                                        <div class="col-md-6 mb-3"><label for="brandId" class="labels">ID</label><input id="brandId" type="text" class="form-control" placeholder="${brand.brandId}" readonly></div>
                                        <div class="col-md-12 mb-3"><label for="brandName" class="labels">Thương hiệu</label><input id="brandName" type="text" class="form-control" name="brandName" maxlength="255" placeholder="${brand.brandName}"></div>
                                        <div class="col-md-12">
                                            <label for="brandDescription" class="labels">Mô tả</label>
                                            <br>
                                            <textarea name="brandDescription" id="brandDescription" class="form-control" cols="50" rows="5" maxlength="2000">${brand.brandDescription}</textarea>
                                        </div>
                                    </div>
                                    <div class="row ml-1 mr-1">
