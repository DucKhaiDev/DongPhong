                                            ...
                                            <div class="p-3 py-5">
                                                <div class="row mt-2 mb-3">
                                                    <div class="col-md-6"><label for="lastName"
                                                                                 class="labels">Họ</label><input
                                                            id="lastName" type="text" class="form-control"
                                                            name="lastName" maxlength="255"
                                                            placeholder="${user.lastName}"></div>
                                                    <div class="col-md-6"><label for="firstName"
                                                                                 class="labels">Tên</label><input
                                                            id="firstName" type="text" class="form-control"
                                                            name="firstName" maxlength="255"
                                                            placeholder="${user.firstName}"></div>
                                                </div>
                                                <div class="row mt-3">
                                                    <div class="col-md-12 mb-3"><label for="username" class="labels">Tên
                                                        đăng nhập</label><input id="username" type="text"
                                                                                class="form-control"
                                                                                placeholder="${user.username}" readonly>
                                                    </div>
                                                    <div class="col-md-12 mb-3"><label for="password" class="labels">Mật
                                                        khẩu</label><input id="password" type="text"
                                                                           class="form-control" name="password"
                                                                           placeholder="${user.password}"></div>
                                                    <div class="col-md-12 mb-3"><label for="email"
                                                                                       class="labels">Email</label><input
                                                            id="email" type="text" class="form-control" name="email"
                                                            maxlength="255" placeholder="${user.email}"></div>
                                                    <div class="col-md-12 mb-3"><label for="address" class="labels">Địa
                                                        chỉ</label><input id="address" type="text" class="form-control"
                                                                          name="address" maxlength="2000"
                                                                          placeholder="${user.address}"></div>
                                                    <div class="col-md-12 mb-3"><label for="phone" class="labels">Số
                                                        điện thoại</label><input id="phone" type="text"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <c:choose>
                                                                    <c:when test="${user.role}">
                                                                        ...
                                                                        <div class="col-md-3"><label>
                                                                            <input type="radio" value="true" name="role"
                                                                                   checked="checked">
                                                                        </label> Thành viên
                                                                        </div>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        ...
                                                                        <% int count = Constant.Service.USER_SERVICE.countAdmin(); %>
                                                                        <div class="col-md-3"><label>
                                                                            <input type="radio" value="true"
                                                                                   name="role" <% if (count <= 1) out.print("disabled"); %>>
                                                                        </label> Thành viên
                                                                        </div>
                                                                    </c:otherwise>
                                                                </c:choose>
